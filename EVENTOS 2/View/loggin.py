...
class Loggin():
    ...
    def validarUsuario(self, event):
        ...
        #if(caracter.isalpha() or caracter=='.' or caracter=="BackSpace" or caracter "Tab"):#isaigit()- isalpha()- isalnum()
    ...
    def __init__(self):
        ...
        #Tooltip(self.txtUsuario, "Ingrese su nombre de usuario, solo letras minusculas, n/ min 5 caracteres , max 25 caracteres.")
